...
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseToken","Exp","Exp1","Term","Factor","let","in","int","var","'='","'+'","'-'","'*'","'/'","'('","')'","%eof"]
...
parseToken tks = happyRunIdentity happySomeParser where
...
parse = getContents >>= print . parseToken . lexer
